...
wget --no-check-certificate https://raw.githubusercontent.com/COVID-19-CTI-LEAGUE/PUBLIC_RELEASE/master/Cyber_threat_Coalition_domain_Blacklist.txt && tr -d '\r' < Cyber_threat_Coalition_domain_Blacklist.txt > ctileagueCOVIDdomains.csv && sed 's/$/,TRUE/' ctileagueCOVIDdomains.csv && echo 'domain,isBad' | cat - ctileagueCOVIDdomains.csv > temp && mv -f temp ctileagueCOVIDdomains.csv  && rm -f Cyber_threat_Coalition_domain_Blacklist*  && mv -f ctileagueCOVIDdomains.csv $SPLUNK_HOME/etc/apps/TA-covidIOCs/lookups/

wget --no-check-certificate https://raw.githubusercontent.com/COVID-19-CTI-LEAGUE/PUBLIC_RELEASE/master/Cyber_Threat_Coalition_hash_Blacklist.txt && tr -d '\r' < Cyber_Threat_Coalition_hash_Blacklist.txt > ctileagueCOVIDhashs.csv && sed 's/$/,TRUE/' ctileagueCOVIDhashs.csv && echo 'hashes,isBad' | cat - ctileagueCOVIDhashs.csv > temp && mv -f temp ctileagueCOVIDhashs.csv  && rm -f Cyber_Threat_Coalition_hash_Blacklist*  && mv -f ctileagueCOVIDhashs.csv $SPLUNK_HOME/etc/apps/TA-covidIOCs/lookups/

wget --no-check-certificate https://raw.githubusercontent.com/COVID-19-CTI-LEAGUE/PUBLIC_RELEASE/master/Cyber_Threat_Coalition_url_Blacklist.txt && tr -d '\r' < Cyber_Threat_Coalition_url_Blacklist.txt > ctileagueCOVIDurls.csv && sed 's/$/,TRUE/' ctileagueCOVIDurls.csv && echo 'url,isBad' | cat - ctileagueCOVIDurls.csv > temp && mv -f temp ctileagueCOVIDurls.csv  && rm -f Cyber_Threat_Coalition_url_Blacklist*  && mv -f ctileagueCOVIDurls.csv $SPLUNK_HOME/etc/apps/TA-covidIOCs/lookups/

wget --no-check-certificate https://raw.githubusercontent.com/COVID-19-CTI-LEAGUE/PUBLIC_RELEASE/master/Cyber_Threat_coalition_ip_Blacklist.txt && tr -d '\r' < Cyber_Threat_coalition_ip_Blacklist.txt > ctileagueCOVIDips.csv && sed 's/$/,TRUE/' ctileagueCOVIDips.csv && echo 'ip,isBad' | cat - ctileagueCOVIDips.csv > temp && mv -f temp ctileagueCOVIDips.csv  && rm -f Cyber_Threat_coalition_ip_Blacklist.txt*  && mv -f ctileagueCOVIDips.csv $SPLUNK_HOME/etc/apps/TA-covidIOCs/lookups/
